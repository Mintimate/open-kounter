    ...
    <div class="bg-dark-800/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-dark-700/50 p-8 relative overflow-hidden group min-h-[320px] flex flex-col justify-center">
      ...
      <div v-else class="relative space-y-6 animate-fade-in">
        ...
        <button 
          ...
          class="w-full py-3.5 bg-gradient-to-r from-primary to-primary-dark hover:from-primary-hover hover:to-primary text-on-accent font-bold rounded-xl shadow-lg shadow-primary/25 hover:shadow-primary/40 transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none flex items-center justify-center gap-2"
        >
          <svg v-if="loading" class="animate-spin h-5 w-5 text-on-accent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
